  ...
  return (
    <>
      ...
      <section className="py-24 relative" id="dores">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent to-[#0c1324] z-0"></div>
        <div className="max-w-7xl mx-auto px-8 relative z-10">
          ...
          >
            ...
            <h2 className="font-headline text-4xl md:text-5xl font-bold mt-4 text-white max-w-4xl mx-auto">
              O problema não é falta de ferramenta.<br/><span className="text-primary">É falta de direção aplicada.</span>
            </h2>
